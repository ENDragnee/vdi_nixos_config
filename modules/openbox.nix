{
  ...
  xdg.configFile."openbox/autostart" = {
    ...
    text = ''
      ...
      ${pkgs.feh}/bin/feh --bg-fill ${config.xdg.configHome}/wallpapers/lock.jpg &
      ${pkgs.clipcat}/bin/clipcatd &
      ${pkgs.tint2}/bin/tint2 -c ~/.config/tint2/livia/livia.tint2rc &
  ...
  xdg.configFile."openbox/rc.xml".text = ''
    ...
    <openbox_config xmlns="http://openbox.org/3.4/rc" xmlns:xi="http://www.w3.org/2001/XInclude">
      ...
      <keyboard>
        ...
        <keybind key="W-space"><action name="MaximizeFull"/></keybind>
        <keybind key="W-A-Up"><action name="MaximizeFull"/></keybind>
        <keybind key="W-A-Down"><action name="Iconify"/></keybind>
        <keybind key="W-q">
          <action name="Execute">
            <startupnotify><enabled>true</enabled><name>Rofi</name></startupnotify>
            <command>~/.config/rofi/applets/bin/powermenu.sh</command>
          </action>
        </keybind>
        <keybind key="W-e">
          <action name="Execute">
        ...
        <keybind key="W-o">
          <action name="Execute">
            <startupnotify><enabled>true</enabled><name>Rofi</name></startupnotify>
            <command>~/.config/rofi/launchers/type-3/launcher.sh</command>
          </action>
        </keybind>
        <keybind key="W-S-a">
          <action name="Execute">
            <startupnotify><enabled>true</enabled><name>Clipcat Menu</name></startupnotify>
            <command>clipcat-menu</command>
          </action>
        </keybind>
      </keyboard>
      <mouse>
        ...
        <context name="Titlebar">
          ...
          <mousebind button="Up" action="Click">
            <action name="if">
              <shaded>no</shaded>
              <then><action name="Shade"/><action name="FocusToBottom"/><action name="Unfocus"/><action name="Lower"/></then>
            </action>
          </mousebind>
          <mousebind button="Down" action="Click">
            <action name="if">
              <shaded>yes</shaded>
              <then><action name="Unshade"/><action name="Raise"/></then>
            </action>
          </mousebind>
        </context>
